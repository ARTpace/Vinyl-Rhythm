...
const MobileNav: React.FC<MobileNavProps> = ({ activeView, onViewChange, trackCount, themeColor = '#eab308' }) => {
  const navItems = [
    ...
    { id: 'albums' as ViewType, label: '专辑', icon: <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 3v18M11 3v18M15 3v18"/></svg> },
